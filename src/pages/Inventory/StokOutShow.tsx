        ...
        <div className="rounded-2xl border-gray-800 bg-white p-8 dark:bg-white/[0.05]">
          ...
          <div className="space-y-4">
            <div className="flex gap-12">
              <span className="font-medium text-gray-600 dark:text-white/70">ID Keluar:</span>
              <span className="dark:text-white/80">{data.id}</span>
            </div>

            <div className="flex gap-2">
              <span className="font-medium text-gray-600 dark:text-white/70">Tanggal Keluar:</span>
            ...
            <div className="flex gap-12">
              <span className="font-medium text-gray-600 dark:text-white/70">PIC:</span>
          ...
          <h2 className="text-xl font-bold my-6 dark:text-white">Detail Barang Keluar</h2>

          <Table>
            <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
              <TableRow>
                <TableCell isHeader className="px-5 py-4 text-start dark:text-white">Kode</TableCell>
                <TableCell isHeader className="px-5 py-4 text-start dark:text-white">Nama</TableCell>
                <TableCell isHeader className="px-5 py-4 text-start dark:text-white">Merk</TableCell>
                <TableCell isHeader className="px-5 py-4 text-start dark:text-white">Satuan</TableCell>
                <TableCell isHeader className="px-5 py-4 text-start dark:text-white">Jumlah</TableCell>
                <TableCell isHeader className="px-5 py-4 text-start dark:text-white">Harga Keluar</TableCell>
                <TableCell isHeader className="px-5 py-4 text-start dark:text-white">Subtotal</TableCell>
              </TableRow>
            </TableHeader>
