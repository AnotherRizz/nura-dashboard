...
export default function PaketIndex() {
  ...
  const fetchPaket = async (currentPage = 1, keyword = "") => {
    setLoading(true);
    try {
      const limit = 10;
      ...
      if (keyword) {
        query = query.ilike("nama_paket", `%${keyword}%`);
      }
  ...
  return (
    <div>
      <PageMeta title="Paket Dashboard" description="Daftar Paket" />
      <PageBreadcrumb pageTitle="Daftar Paket Internet" />
              ...
              <form>
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="temukan paket yang ingin anda cari..."
