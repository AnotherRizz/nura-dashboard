...
export default function GudangShow() {
        ...
        <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-8 dark:border-gray-800 dark:bg-gradient-to-br dark:from-sky-950 dark:to-gray-900">
          ...
          <div className="space-y-4">
            <div className="flex justify-between">
              <span className="font-medium text-gray-600 dark:text-gray-400">Nama Gudang:</span>
              <span className="text-gray-900 dark:text-white">{gudang.nama_gudang}</span>
            </div>

            <div className="flex justify-between">
              <span className="font-medium text-gray-600 dark:text-gray-400">Lokasi:</span>
              <span className="text-gray-900 dark:text-white">{gudang.lokasi || "-"}</span>
            </div>

            <div className="flex justify-between">
              <span className="font-medium text-gray-600 dark:text-gray-400">Keterangan:</span>
              <span className="text-gray-900 dark:text-white">{gudang.keterangan || "-"}</span>
            </div>

            <div className="flex justify-between">
              <span className="font-medium text-gray-600 dark:text-gray-400">Total Barang:</span>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-8 dark:border-gray-800 dark:bg-white/[0.03]">
          ...
          <Table>
           <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                ...
                <TableCell isHeader
                          className="px-5 py-4 text-start dark:text-white sm:px-6">Stok</TableCell>
                <TableCell isHeader
                          className="px-5 py-4 text-start dark:text-white sm:px-6">Harga</TableCell>
              </TableRow>
            </TableHeader>
            ...
            <TableBody  className="divide-y divide-gray-100 dark:divide-white/[0.05]">
              {filteredBarang.map((b) => (
                <TableRow key={b.id}>
                  <TableCell className="px-4 py-3 dark:text-white/80">{b.nama_barang}</TableCell>
                  <TableCell className="px-4 py-3 dark:text-white/80">{b.kode_barang}</TableCell>
                  <TableCell className="px-4 py-3 dark:text-white/80">{b.stok} {b.satuan}</TableCell>
